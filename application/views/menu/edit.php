							...
							<div class="col-xs-12">
								...
								<div class="row">
									...
									<div class="col-sm-4">
										<div class="widget-box">
											<div class="widget-header">
												<h4 class="widget-title">Ubah Menu</h4>
												<span class="widget-toolbar">
													<a href="#" data-action="collapse">
														<i class="ace-icon fa fa-chevron-up"></i>
													</a>
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<form method="POST" action="<?= base_url('menu/update') ?>/<?= $edit->id ?>">
													<div class="space-4"></div>
														...
														<div class="form-group">
															...
															<div>
																<input type="text" name="nama_menu" placeholder="Nama Menu" value="<?= $edit->nama_menu ?>" style="width:100%;"  />
															</div>
														</div>
													<div class="space-4"></div>
														...
														<div class="form-group">
															...
															<div>
																<input type="text" name="harga" placeholder="Harga Menu"  value="<?= $edit->harga ?>" style="width:100%;"  />
															</div>
														</div>
													<div class="space-4"></div>
