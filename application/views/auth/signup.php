...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Login Page - Kasir App</title>
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red">Kasir</span>
									<span class="white" id="id-text2">Application</span>
								</h1>
								<h4 class="blue" id="id-company-text">&copy; KasirKu</h4>
							</div>
								...
								<div id="signup-box" class="signup-box visible widget-box no-border">
									<div class="widget-body">
												...
												<fieldset>
													...
													<label class="block clearfix">
														<select class="form-control" name="level">
															<option value="1">Pilih Level (default pelayan)</option>
													...
													<div class="clearfix">
														...
														<button type="submit" name="submit" value="Submit" class="width-65 pull-right btn btn-sm btn-success">
										...
										<div class="toolbar center">
											<a href="<?= base_url('auth') ?>" data-target="#login-box" class="back-to-login-link">
